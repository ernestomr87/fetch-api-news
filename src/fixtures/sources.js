...
export const categories = [
  { color: "#d4380d", value: "entertainment", name: "Entertainment" },
  { color: "#ffa940", value: "general", name: "General" },
  { color: "#ff4d4f", value: "health", name: "Health" },
  { color: "#bae637", value: "science", name: "Science" },
  { color: "#40a9ff", value: "sports", name: "Sports" },
  { color: "#f759ab", value: "technology", name: "Technology" }
];
...
export const languages = [
  { color: "magenta", value: "ar", name: "Arabic" },
  { color: "red", value: "de", name: "Deutsch" },
  { color: "volcano", value: "en", name: "English" },
  { color: "orange", value: "es", name: "Spanish" },
  { color: "gold", value: "fr", name: "French" },
  { color: "lime", value: "he", name: "Hebrew" },
  { color: "green", value: "it", name: "Italian" },
  { color: "cyan", value: "nl", name: "Dutch" },
  { color: "blue", value: "no", name: "Norwegian" },
  { color: "geekblue", value: "pt", name: "Portuguese" },
  { color: "purple", value: "ru", name: "Russian" },
  { color: "#8c8c8c", value: "se", name: "Northern Sami" },
  { color: "#91D5FF", value: "ud", name: "Urdu" },
  { color: "#002329", value: "zh", name: "Chinese" }
];
