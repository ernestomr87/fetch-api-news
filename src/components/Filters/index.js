						...
						<Row>
							<Form>
								...
								{!this.props.news ? (
									...
									<ColFilter xs={24} md={5}>
										<FormItem label="EndPoint" {...formItemLayout} colon={false}>
											<Select
								...
								<ColFilter xs={24} md={5}>
									<FormItem label="Category" {...formItemLayout} colon={false}>
										<Select defaultValue={this.state.category} onChange={this.handleChangeCategory}>
											{!this.props.news ? <Option value="all">All</Option> : null}
								...
								<ColFilter xs={24} md={5}>
									<FormItem label="Country" {...formItemLayout} colon={false}>
										<Select
											defaultValue={this.props.news ? 'Cuba' : this.state.country}
